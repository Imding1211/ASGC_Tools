...
#==============================================================================
"""
Hostname = "202.169.170.130" #IP位置
Username = "centos" #使用者名稱
Password = "" #使用者密碼

get_name = "*.py" #要上傳的檔案名稱

remote_Path = '/home/centos/Utilization' #下載位置，必須為資料夾
local_Path  = 'C:/Users/user/OneDrive/桌面/test' #存檔位置，必須為資料夾
...
get_name = "hostcert.pem" #要上傳的檔案名稱

remote_Path = '/asgc_ui_home/imding1211/hostname_ca/hpstor/hpstor21/key' #下載位置，必須為資料夾
